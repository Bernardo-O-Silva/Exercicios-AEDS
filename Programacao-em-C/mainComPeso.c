...
Lista **criaGrafo(Lista **grafoBusca, int numVertices, int **matrizPesos){//Função já pra criar o grafo aleatório
    ...
    for (comparador = 0; comparador < numVertices; comparador++){
        ...
        matrizPesos[comparador] = (int*)malloc(numVertices * sizeof(int));
    ...
    for (comparador = 0; comparador < numVertices; comparador++){
        ...
        for (comparador2 = 0; comparador2 < numVertices; comparador2++){
            ...
            if (valorBinario == SIM){
                ...
                matrizPesos[comparador][comparador2] = rand() % 30;
...
int problemaResolve()
{
	...
	int vertices, v, v1, v2, origem, destino, limite, i, seed, **matrizPesos;
	...
	matrizPesos = (int**)malloc(vertices * sizeof(int*));    
	resultado_busca_dfs = (Info_dfs*)malloc(vertices * sizeof(Info_dfs));

	criaGrafo(grafo, vertices, matrizPesos);
